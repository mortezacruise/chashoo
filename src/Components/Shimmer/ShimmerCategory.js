...
Animated.LinearGradient = Animated.createAnimatedComponent(
  CustomLinearGradient
);

class ShimmerCategory extends Component {
  constructor(props) {
    super(props);
...
ShimmerCategory.defaultProps = {
  width: 200,
  height: 15,
  widthShimmer: 0.7,
  duration: 2000,
  colorShimmer: ["#f2f2f2", "#dfdfdf", "#f2f2f2"],
  reverse: false,
  autoRun: false,
  visible: false,
