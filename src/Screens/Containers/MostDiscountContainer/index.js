...
import SearchRow from "../../../Screens/Rows/SearchRow"
export default class MostDiscountContainer extends React.Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  getProductRequest() {
    ...
    fetch(BASE_URL + `/special/mostDiscount/${page}`)
